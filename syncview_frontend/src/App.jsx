  ...
  return (
    <BrowserRouter>
      <Routes>
        ...
        <Route path="/bookmark" element={<Bookmark user={user} setUser={setUser} />} />
        ...
        <Route path="/customized" element={<Customized user={user} setUser={setUser} />} />
         {/* 로그인이 필요한 페이지는 Redirect 처리 예시 */}
        <Route
          path="/protected"
          element={user ? <NewsFeed user={user} /> : <Navigate to="/login" />}
        />
